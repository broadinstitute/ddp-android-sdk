...
class GetMailingAddressesRequest : PepperRequest<List<MailingAddress>>() {

    override fun getResultAsync(
        scope: CoroutineScope,
        dataSources: DataSources
    ): Deferred<Result<List<MailingAddress>>> = scope.async {
        dataSources.mailingDataSource.getMailingAddresses(this@GetMailingAddressesRequest)
    }
}